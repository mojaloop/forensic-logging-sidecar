...
psql <<'EOSQL'
    DROP DATABASE IF EXISTS "sidecar_integration";
	  CREATE DATABASE "sidecar_integration";
EOSQL

export SIDE_DATABASE_URI="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:15432/sidecar_integration"
